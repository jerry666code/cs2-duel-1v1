...
// The official alliedmodders/hl2sdk-cs2 calls this struct NetworkStateChangedData;
// some community SDK forks call it NetworkStateChanged_t. Constructor signatures
// are identical, so alias it here rather than forking the calls below per-SDK.
typedef NetworkStateChangedData NetworkStateChanged_t;
